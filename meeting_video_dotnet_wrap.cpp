...
namespace ZOOM_SDK_DOTNET_WRAP {
	...
	SDKError CMeetingVideoControllerDotNetWrap::StopAttendeeVideo(unsigned int userid) {
		return (SDKError)ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetMeetingServiceWrap().GetMeetingVideoController().StopAttendeeVideo(userid);
	}
